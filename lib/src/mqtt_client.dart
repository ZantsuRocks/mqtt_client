...
class MqttClient {
  ...
  Future<MqttClientConnectionStatus?> connect([String? username, String? password]) async {
    ...
    if (keepAlivePeriod != MqttClientConstants.defaultKeepAlive) {
      ...
      keepAlive = MqttConnectionKeepAlive(connectionHandler, clientEventBus, keepAlivePeriod, disconnectOnNoResponsePeriod);
  ...
  void _disconnect({bool unsolicited = true}) {
    ...
    connectionHandler?.connection?.cancelListener();
